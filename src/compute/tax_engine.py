...
def compute_taxable_income_old_regime(profile: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # ---- Gross Total Income ----
    gross_salary = income.get("salary", 0) or 0
    ...
    # Primary: section_80c in your payload
    # Also supports alternative keys if you later add them
    total_deductions = (
        float(deductions.get("section_80c", 0) or 0)
