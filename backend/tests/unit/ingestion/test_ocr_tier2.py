...
from backend.app.ingestion.extractors.ocr_local import OCRLocalExtractor
from backend.app.ingestion.pipeline import ExtractionPipeline
from backend.app.ingestion.parsers.base import BaseParser, DocumentType, ParseStatus
...
def test_ocr_extractor_streaming_mock():
    ...
    with patch('backend.app.ingestion.extractors.ocr_local.convert_from_path') as mock_convert, \
         patch('backend.app.ingestion.extractors.ocr_local.pytesseract') as mock_tess:
