...
from api.ingestion.extractors.ocr_cloud import OCRCloudExtractor
...
def test_cloud_ocr_extractor_mock():
    ...
    with patch('api.ingestion.extractors.ocr_cloud.vision') as mock_vision, \
         patch('api.ingestion.extractors.ocr_cloud.convert_from_path') as mock_convert, \
